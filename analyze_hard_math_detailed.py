...
def plot_failure_bar_graph(results, output_path):
    ...
    bars2 = ax.bar(x + width/2, best_of_five_performance, width,
                   color="#485F52", alpha=0.8, label="pass@5")
...
def main():
    ...
    csv_files = glob.glob("src/problem_difficulty/*_hard-math-v0_difficulty.csv")
    ...
    print("=" * 100)
    print("Analyzing what percentage of hard math problems each model gets wrong after 5 tries")
    print()
