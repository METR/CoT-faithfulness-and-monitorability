...
from free_response_behaviors import FreeResponseBehavior
...
if __name__ == "__main__":
    ...
    RAW_DATA_DIR = f"{project_root}/results/clue_difficulty_replication/{model_short_name}/"
    RAW_DATA_PATH: str = f"{RAW_DATA_DIR}/{date_str}.json"

    cases = list([
        FreeResponseBehavior.REWARD_HACKING,
        FreeResponseBehavior.SYCOPHANCY_EASY_ANSWER,
        FreeResponseBehavior.METADATA_PROMPT,
        FreeResponseBehavior.UNETHICAL_INFORMATION_PROMPT,
    ])
